...
function printPerson(person) {
  ...
  let isTall = person.height > 50 
  let isOverweight = !person.weight < 200
  let isAdult = person.age > 14
  let canRideAmusementParkRide = isTall && !isOverweight && isAdult
  ...
  let isObese = (person.height > 200 && person.weight > 300)
    || (person.height > 50 && person.weight > 100)
    || (person.height > 40 && person.weight > 50);
